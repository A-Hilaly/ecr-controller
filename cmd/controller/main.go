...
import (
	...
	repov1 "github.com/aws-controllers-k8s/ecr-controller/apis/v1alpha1"
	repov2 "github.com/aws-controllers-k8s/ecr-controller/apis/v1alpha2"
...
func main() {
	...
	fmt.Println("start wbsetup")
	if err = (&repov1.Repository{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Repository")
		os.Exit(1)
	}
	if err = (&repov2.Repository{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Repository")
		os.Exit(1)
	}
